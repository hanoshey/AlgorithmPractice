...
class IntSet_07_01(  // 집합의 최대 개수
    ...
    // 집합 s와 같은지 확인합니다.
    fun equalTo(s: IntSet_07_01): Boolean {
    ...
    fun unionOf(s1: IntSet_07_01, s2: IntSet_07_01) {
