import chap09.ArrayLinkedList
import java.util.*

internal object ArrayLinkedListTester {
    ...
    fun main(args: Array<String>) {
        ...
        val list: ArrayLinkedList<Data> = ArrayLinkedList(100)
        do {
    ...
    internal enum class Menu  // 생성자(constructor)
        ...
        SEARCH_NO("번호 검색"), SEARCH_NAME("이름 검색"), NEXT("선택 노드 진행"), PRINT_CRNT("선택 노드 표시"), DUMP("전체 노드 표시"), TERMINATE(
            "종료"
        );
